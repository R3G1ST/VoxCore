...
public sealed class FriendItem
{
    ...
    public string Status => Online ? "в сети" : "не в сети";

    public SolidColorBrush OnlineBrush =>
        Online ? MainWindow.BrushFromHex("#3ba55d") : MainWindow.BrushFromHex("#4e5058");

    public FriendItem(int id, string name, string color, bool online)
    {
        Id = id;
        Name = name;
    ...
    public static FriendItem FromUser(UserInfo u) => new(u.Id, u.Name, u.Color, u.Online);
}